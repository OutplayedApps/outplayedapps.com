...
if ( file_put_contents ( "/var/www/html/wp-content/themes/new/functions.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/var/www/html/wp-content/plugins/aceide/backups/themes/new/functions_2017-04-27-13.php" ) ) ) ) {
