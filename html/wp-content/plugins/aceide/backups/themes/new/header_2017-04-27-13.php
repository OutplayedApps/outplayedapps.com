...
if ( file_put_contents ( "/var/www/html/wp-content/themes/new/header.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/var/www/html/wp-content/plugins/aceide/backups/themes/new/header_2017-04-27-13.php" ) ) ) ) {
...
<head>
    ...
    <meta property="og:image" content="http://outplayedapps.com/wp-content/uploads/2017/04/logo.png" />
    <meta property="og:title" content="<?php echo 'Outplayed - '.the_title(); ?>" />
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class=" <?php echo $slug=="blog"?"active":"" ?>"><?php echo $slug."a" ?>
